...
module.exports.run = async (client, message) => {
  ...
  if (command.authorPermission) {
    ...
    if (Permissions.length) return message.channel.send(`You Need ${Permissions.join(", ")} Permission To Execute This Command!`)
  }

  /* O W N E R */
  if (command.ownerOnly) {
    if (message.author.id !== ownerID) return message.channel.send("This Command Can Only Be Used By My Owner!")
  }
